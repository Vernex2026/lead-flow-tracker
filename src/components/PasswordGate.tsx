    ...
    <main className="flex min-h-screen items-center justify-center bg-bg p-6">
      <div className="w-full max-w-sm">
        <div className="rounded-xl border border-border bg-surface p-8 shadow-sm">
          <div className="mx-auto mb-5 flex h-11 w-11 items-center justify-center rounded-full bg-surface-2 text-ink-2">
            <Lock className="h-5 w-5" aria-hidden />
          </div>
          <h1 className="text-center text-[18px] font-semibold tracking-tight text-ink-1">
            Dostęp ograniczony
          </h1>
          <p className="mt-2 text-center text-[13px] leading-relaxed text-ink-3">
            Ta wersja prototypu YouLead wymaga hasła. Jeśli go nie masz,
